 <script lang="ts">
  ...
  let linkCls = () => `nav-link flex items-center
    ${twMerge(config.linkClasses, active && config.activeLinkClasses, (config?.isDropdown ? "hover:bg-secondary dark:hover:bg-tertiary rounded-none " + config.dropdownLinkClasses : ""), props.class as string)}
